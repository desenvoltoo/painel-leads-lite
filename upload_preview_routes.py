...
Evita depender de sitecustomize/usercustomize no container.
"""
...
def register_upload_preview_routes(app) -> None:
    ...
    def api_upload_preview_real():
        try:
            ...
            return jsonify({"ok": True, "data": {**metrics, "campos_operacionais": operational_present, "campos_preservados": sorted(present & (PERSONAL_FIELDS | ACADEMIC_FIELDS)), "exemplos": examples}})
