...
CREATE OR REPLACE VIEW `painel-universidade.modelo_estrela.vw_op_fila_disponivel` AS
SELECT l.*
...
WHERE op.sk_pessoa IS NULL AND COALESCE(l.flag_matriculado,FALSE)=FALSE;
